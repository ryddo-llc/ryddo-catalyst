...
${COMPANY_INFO.copyrightAgent.company}<br />
${COMPANY_INFO.copyrightAgent.address}<br />
${COMPANY_INFO.copyrightAgent.city}, ${COMPANY_INFO.copyrightAgent.state}. ${COMPANY_INFO.copyrightAgent.zip}<br /><br />

Attention: ${COMPANY_INFO.copyrightAgent.attention}<br />
Email: ${COMPANY_INFO.copyrightAgent.email}`
    }
  ]
}; 