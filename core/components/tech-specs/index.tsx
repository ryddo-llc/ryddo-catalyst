...
interface TechSpecsProps {
  powerSpecs?: Streamable<PowerSpecsTypes[]>;
}
...
const TechSpecs = ({ powerSpecs }: TechSpecsProps) => {
  ...
  const defaultPowerSpecs: PowerSpecsTypes[] = [
    {
      title: 'Motor Power',
      content:
        '3000W dual motor system providing exceptional acceleration and hill climbing capability up to 35° inclines.',
    },
    {
      title: 'Battery Capacity',
      content:
        '72V 35Ah lithium-ion battery pack with Samsung cells, offering up to 65 miles of range on a single charge.',
    },
    {
      title: 'Max Speed',
      content:
        '40 mph top speed with multiple riding modes including Eco, Normal, and Sport for different performance needs.',
    },
    {
      title: 'Charging Time',
      content:
        'Fast charging capability - 80% charge in 4 hours, full charge in 6 hours with included smart charger.',
    },
    {
      title: 'Power Output',
      content:
        'Peak power output of 6000W for maximum acceleration and performance in demanding conditions.',
    },
    {
      title: 'Voltage System',
      content:
        '72V electrical system with regenerative braking to extend range and improve battery efficiency.',
    },
    {
      title: 'Energy Efficiency',
      content:
        'Advanced power management system with energy recovery and intelligent power distribution.',
    },
    {
      title: 'Controller',
      content:
        'Sine wave controller with temperature monitoring and overcurrent protection for optimal performance.',
    },
  ];

  const streamablePowerSpecs = powerSpecs || defaultPowerSpecs;
                  ...
                  <div className="pb-6 md:pb-8">
                    {section.key === 'power' ? (
                      ...
                      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 md:gap-8 lg:grid-cols-4">
                        {finalPowerSpecs.map((spec, specIndex) => (
                      ...
                      <div className="rounded-lg p-4 md:p-6">
                        <p className="text-base text-gray-600 md:text-lg">
                          Content for {section.title} would go here. This is where you would add the
