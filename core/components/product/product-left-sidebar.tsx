...
export function ProductLeftSidebar({
  ...
  return (
    <div className="absolute left-0 top-[-26px] z-10 hidden w-52 min-h-[400px] rounded-2xl bg-white/75 p-3 md:top-[-31px] md:block md:w-60 md:p-4 lg:top-[-36px] lg:w-60 lg:p-5 xl:left-1 xl:w-72 xl:p-6 -ml-2 sm:-ml-4 md:-ml-6 lg:-ml-8 xl:-ml-12">
      <Stream
