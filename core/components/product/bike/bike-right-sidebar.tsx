...
export function BikeRightSidebar<F extends Field>({
  ...
  return (
    <div className="absolute right-0 top-[-10px] z-10 hidden w-60 min-h-[400px] md:top-[-15px] md:block md:w-72 lg:top-[-20px] lg:w-72 xl:right-1 xl:w-80 -mr-6 sm:-mr-8 md:-ml-12 lg:-mr-16 xl:-mr-20">
      <Stream
