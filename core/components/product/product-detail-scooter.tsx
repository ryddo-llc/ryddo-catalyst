...
interface ProductDetailScooterProduct {
  id: string;
  title: string;
  href: string;
            ...
            product && (
              <div className="grid grid-cols-1 items-stretch gap-x-8 gap-y-8 @2xl:grid-cols-2 @5xl:gap-x-12">
                ...
                <div className="text-[var(--product-detail-primary-text,hsl(var(--foreground)))]">
                  ...
                  {/* Scooter-specific quick specs section */}
                  <div className="group/scooter-quick-specs mb-6">
                      ...
                      {(specs) =>
                        specs && (
                          <div className="rounded-lg border border-[var(--product-detail-border,hsl(var(--contrast-100)))] p-4">
                            ...
                            {/* Scooter-specific highlight badges */}
...
// Skeleton components (reusing from original with scooter-specific additions)
