...
export function PaymentOptions() {
  return (
    <section
      className="relative w-full h-screen max-h-[800px] overflow-hidden py-20 font-['Nunito']"
    >
      <Image
        alt=""
        aria-hidden="true"
        ...
        fill
        src="/images/backgrounds/payment-options-background.webp"
      />
      <div
        className="relative mx-auto lg:ml-[16vw] lg:mr-0
          w-[90vw] max-w-[500px] min-w-0 md:min-w-[320px]
          h-[70vh] overflow-hidden rounded-xl"
      >
        <Image
          alt=""
          aria-hidden="true"
        ...
        <div className="relative flex flex-col h-full min-h-0 p-6 sm:p-8">
          ...
          <div className="md:px-2 flex-1 min-h-0 overflow-y-auto overscroll-contain">
