    ...
    >
      ...
      {layout === 'center' && (
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
          <ArrowButton aria-hidden="true" className="text-[#FFFFFF] pointer-events-none" tabIndex={-1}>
            Shop
          </ArrowButton>
      ...
      {layout === 'default' && (
        ...
        <>
          ...
          <div className="absolute bottom-4 left-4">
            <ArrowButton aria-hidden="true" className="pointer-events-none" tabIndex={-1}>
              Shop
            </ArrowButton>
          </div>
        </>
