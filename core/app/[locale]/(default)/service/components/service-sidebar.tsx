...
export function ServiceSidebar({ 
  ...
  return (
    <aside className="border-b lg:border-b-0 lg:border-r border-gray-200 bg-gray-50/60 backdrop-blur-md p-4 lg:p-6 w-full lg:w-64 rounded-t-3xl lg:rounded-t-none lg:rounded-l-3xl flex flex-col">
