...
export function Card({
  ...
  return (
    <article
      className={clsx(
        'rounded-(--card-border-radius,1rem) font-(family-name:--card-font-family,var(--font-family-body)) group relative flex w-full min-w-0 max-w-md cursor-pointer flex-col gap-2 @container',
        {
          small: 'gap-2',
          medium: 'gap-3',
          large: 'gap-4',
    ...
    >
      ...
      <div
        className={clsx(
          'group-focus:ring-(--card-focus,var(--primary)) relative overflow-hidden rounded-[inherit] group-focus-visible:ring-2',
          {
      ...
      <Link
        className={clsx(
          'rounded-(--card-border-radius,1rem) focus:outline-hidden focus-visible:ring-(--card-focus,var(--primary)) absolute inset-0 focus-visible:ring-2 focus-visible:ring-offset-4',
          {
